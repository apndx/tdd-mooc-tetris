...
export class Board {
  ...
  isThereSpaceBelow(rowIdx, colIdx) {
    ...
    console.log("space", rowIdx + 1, colIdx, emptySpace);
  ...
  rotateFallingRight() {
    if (this.fallingBlock !== null && this.fallingBlock.color !== "O") {
      ...
      this.fallingBlock = new RotatingShape(
        ...
        this.fallingBlock.cornerY
      );
      console.log("jälkrot", this.fallingBlock);
  ...
  rotateFallingLeft() {
    if (this.fallingBlock !== null && this.fallingBlock.color !== "O") {
      ...
      const newLimits =
        this.fallingBlock.color === "T"
          ? this.getTLeftRotationLimits(oldLimits)
          : this.getIRotationLimits(oldLimits);
      this.fallingBlock = new RotatingShape(
        this.fallingBlock.shape,
        this.fallingBlock.color,
